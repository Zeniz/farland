...
public:
	...
	void renderABS(float destX, float destY, float sourX, float sourY,
		int sourWidth, int sourHeight, float alpha = 1.0f);
	...
	void render(float destX, float destY, int showWidth, int showHeight, float sourX, float sourY,
		int sourWidth, int sourHeight, float alpha = 1.0f);
	void renderABS(float destX, float destY, int showWidth, int showHeight, float sourX, float sourY,
		int sourWidth, int sourHeight, float alpha = 1.0f);
	...
	void frameRenderABS(float destX, float destY, int currentFrameX, int currentFrameY, float alpha = 1.0f);


	void frameRenderAngle(float destX, float destY, int currentFrameX, int currentFrameY, float angle, float alpha = 1.0f);
	void frameRenderAngleABS(float destX, float destY, int currentFrameX, int currentFrameY, float angle, float alpha = 1.0f);
	...
	void frameRenderABS(float destX, float destY, int showWidth, int showHeight, int currentFrameX, int currentFrameY, float alpha = 1.0f);
	...
	void frameRenderABS(float destX, float destY, int sourX, int sourY, int sourWidth, int sourHeight, int currentFrameX, int currentFrameY, float alpha = 1.0f);
